...
neffLin = linspace(3.305, n2, 10);

neffPlot = zeros(length(widthLin));


for i = 1:length(neffLin)
    
    [x,y,xc,yc,nx,ny,eps,edges] = waveguidemesh([n1,neffLin(i),n3],[h1,h2,h3], ...
                                            rh,rw,side,dx,dy); 
